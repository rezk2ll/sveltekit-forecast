<script lang="ts">
	import type { WeatherInformation } from '$lib/types';

	export let weather: WeatherInformation;
...
<div class="card card-compact w-96">
	...
	<div class="flex flex-row space-x-3">
		<button class="btn btn-disabled gap-3">
    <svg
